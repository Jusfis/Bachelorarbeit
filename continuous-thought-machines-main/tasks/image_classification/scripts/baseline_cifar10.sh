...
#SBATCH --output=/home/f/fischerjus/Bachelorarbeit/continuous-thought-machines-main/tasks/image_classification/baseline_slurm.%j.%N.out
...
python -m tasks.image_classification.image_baseline_mlp \
--log_dir $LOG_DIR \
--dataset cifar10 \
--d_model 256 \
--d_input 64 \
