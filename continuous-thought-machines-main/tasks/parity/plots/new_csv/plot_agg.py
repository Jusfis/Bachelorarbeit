...
# --- Funktion zum Aggregieren der Baseline über alle Sweeps ---
...
# Smoothing der KAN / MLP Trainigsdaten
...
# Smoothing der Baseline-Trainingsdaten (nur die neu aggregierten Spalten)
