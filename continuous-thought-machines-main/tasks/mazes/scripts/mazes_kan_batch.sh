#!/bin/bash
#
#SBATCH --job-name=kan_maze_wandb_sweeps
...
#SBATCH --output=/home/f/fischerjus/Bachelorarbeit/continuous-thought-machines-main/tasks/maze/slurm.%j.%N.out
...
#sbatch --partition=NvidiaAll mazes_kan_batch.sh script for slurm